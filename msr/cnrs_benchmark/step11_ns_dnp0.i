...
[Modules]
  [NavierStokesFV]
    ...
    passive_scalar_names = 'c0'
    passive_scalar_coupled_source = 'fission_source c0'
    passive_scalar_coupled_source_coeff = '${beta0} ${lambda0}'
    ...
    #                                       ${beta3} ${lambda3}; ${beta4} ${lambda4}; ${beta5} ${lambda5};
